                ...
                <View style={styles.footerInner}>
                    ...
                    <View style={styles.columnsWrapper}>
                        ...
                        <View style={styles.brandCol}>
                            <View style={styles.brandHeader}>
                                ...
                                <Text style={styles.brandTitle}>Sassy Magic Eightball</Text>
                            </View>
                        ...
                        <View style={styles.linkCol}>
                            ...
                            <Link href="/" style={styles.linkItem}>
                                <Text style={styles.linkText}>Interactive Eightball</Text>
                            </Link>
                    ...
                    <View style={styles.disclaimerBox}>
                        ...
                        <Text style={[styles.disclaimerText, { marginTop: 8 }]}>
                            ...
                            The Sassy Magic Eightball is created solely for entertainment and comedic amusement. Responses are pseudorandomly generated by computer algorithms and do not constitute financial, legal, psychological, or medical advice. Always use sound judgment.
                        </Text>
                    </View>
                    ...
                    <View style={styles.bottomBar}>
                        <Text style={styles.copyrightText}>
                            &copy; {new Date().getFullYear()} Sassy Magic Eightball. All rights reserved. Made with sassy love and chaotic good vibes.
                        </Text>
                    </View>
                </View>
            </View>
